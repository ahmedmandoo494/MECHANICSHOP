...
{
    public static MarkupString GetStatusBadge(WorkOrderStatus? state)
    {
        return state switch
        {
            WorkOrderStatus.Scheduled => (MarkupString)"<span class='badge mx-1 text-warning'><i class='bi bi-hourglass-split'></i> Scheduled</span>",
            WorkOrderStatus.InProgress => (MarkupString)"<span class='badge mx-1 text-secondary'><i class='bi bi-tools'></i> InProgress</span>",
            WorkOrderStatus.Completed => (MarkupString)"<span class='badge mx-1 text-success'><i class='bi bi-check-all'></i> Completed</span>",
            WorkOrderStatus.Cancelled => (MarkupString)"<span class='badge mx-1 text-danger'><i class='bi bi-x-circle'></i> Cancelled</span>",
