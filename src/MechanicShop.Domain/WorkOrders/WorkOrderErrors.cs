...
public static class WorkOrderErrors
{
    ...
    public static Error TimingReadonly(string id, WorkOrderStatus state) => Error.Conflict(
    ...
    public static Error InvalidStateTransition(WorkOrderStatus current, WorkOrderStatus next) => Error.Conflict(
