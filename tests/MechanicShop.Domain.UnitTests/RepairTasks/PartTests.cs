...
public class PartTests
{
    ...
    public void Create_WithInvalidName_ShouldFail()
    {
        ...
        Assert.Equal(PartError.NameRequire.Code, result.TopError.Code);
    }
    ...
    public void Create_WithInvalidCost_ShouldFail()
    {
        ...
        Assert.Equal(PartError.CostInvalid.Code, result.TopError.Code);
    }
    ...
    public void Create_WithInvalidQuantity_ShouldFail()
    {
        ...
        Assert.Equal(PartError.QuantityInvalid.Code, result.TopError.Code);
    }
