...
public class InvoiceTests()
{
    ...
    public void Create_WithEmptyItems_ShouldFail()
    {
        ...
        Assert.Equal(InvoiceError.LineItemEmpty.Code, result.TopError.Code);
    }
    ...
    public void ApplyDiscount_WithNegativeAmount_ShouldFail()
    {
        ...
        Assert.True(result.IsError);
        Assert.Equal(InvoiceError.DiscountNegative.Code, result.TopError.Code);
    }
    ...
    public void ApplyDiscount_GreaterThanSubtotal_ShouldFail()
    {
        ...
        Assert.True(result.IsError);
        Assert.Equal(InvoiceError.DiscountExceedsSubTotal.Code, result.TopError.Code);
    }
    ...
    public void ApplyDiscount_WhenPaid_ShouldFail()
    {
        ...
        var result = invoice.ApplayDiscount(10);
        Assert.True(result.IsError);
        Assert.Equal(InvoiceError.InvoiceLocked.Code, result.TopError.Code);
    }
