...
public class InvoiceLineItemTests
{
    ...
    public void Create_WithEmptyInvoiceId_ShouldFail()
    {
        ...
        Assert.Equal(InvoiceLineItemError.InvoiceIdRequired.Code, result.TopError.Code);
        Assert.Equal(InvoiceLineItemError.InvoiceIdRequired.Description, result.TopError.Description);
    }
    ...
    public void Create_WithInvalidLineNumber_ShouldFail()
    {
        ...
        Assert.True(result.IsError);
        Assert.Equal(InvoiceLineItemError.LineNumberRequired.Code, result.TopError.Code);
        Assert.Equal(InvoiceLineItemError.LineNumberRequired.Description, result.TopError.Description);
    }
    ...
    public void Create_WithEmptyDescription_ShouldFail()
    {
        ...
        Assert.True(result.IsError);
        Assert.Equal(InvoiceLineItemError.DescriptionRequired.Code, result.TopError.Code);
        Assert.Equal(InvoiceLineItemError.DescriptionRequired.Description, result.TopError.Description);
    }
    ...
    public void Create_WithInvalidQuantity_ShouldFail()
    {
        ...
        Assert.True(result.IsError);
        Assert.Equal(InvoiceLineItemError.QuantityInvalid.Code, result.TopError.Code);
        Assert.Equal(InvoiceLineItemError.QuantityInvalid.Description, result.TopError.Description);
    }
    ...
    public void Create_WithInvalidUnitPrice_ShouldFail()
    {
        ...
        Assert.True(result.IsError);
        Assert.Equal(InvoiceLineItemError.UnitPriceInvalid.Code, result.TopError.Code);
        Assert.Equal(InvoiceLineItemError.UnitPriceInvalid.Description, result.TopError.Description);
    }
}