...
public class CustomerTests
{
    ...
    public void CreateCustomer_ShouldSucceed_WithValidData()
    {
        ...
        List<Vehicle> vehicle = [VehicleFactory.CreateVehicle().Value];

        var result = CustomerFactory.CreateCustomer(id: id, name: name, phoneNumber: phoneNumber, email: email, vehicles: vehicle);
