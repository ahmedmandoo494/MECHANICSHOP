...
public class CreateWorkOrderCommandHandlerTests(WebAppFactory factory)
{
    ...
    public async Task Handle_WithValidData_ShouldSucceed()
    {
        ...
        Assert.Equal(Spots.B, result.Value.Spot);
    ...
    public async Task Handle_WithOutsideOperatingHours_ShouldFail()
    {
        var customer = CustomerFactory.CreateCustomer().Value;
        var vehicle = customer.Vehicles.First();
        var repairTask = RepairTaskFactory.CreateRepairTask(repairDurationInMinutes: RepairDurationInMinute.Min60).Value;
        var employee = EmployeeFactory.CreateEmployee().Value;
        ...
        var command = new CreateWorkOrderCommand(Spots.B, vehicle.Id, scheduledAt, [repairTask.Id], employee.Id);
        var result = await _mediator.Send(command);
    ...
    public async Task Handle_WithShortDuration_ShouldFail()
    {
        var customer = CustomerFactory.CreateCustomer().Value;
        var vehicle = customer.Vehicles.First();
        var repairTask = RepairTaskFactory.CreateRepairTask(repairDurationInMinutes: RepairDurationInMinute.Min15).Value;
        var employee = EmployeeFactory.CreateEmployee().Value;
        ...
        var command = new CreateWorkOrderCommand(Spots.A, vehicle.Id, scheduledAt, [repairTask.Id], employee.Id);
        var result = await _mediator.Send(command);
    ...
    public async Task Handle_WithMissingVehicle_ShouldFail()
    {
        ...
        var command = new CreateWorkOrderCommand(Spots.C, Guid.NewGuid(), scheduledAt, [repairTask.Id], employee.Id);
        var result = await _mediator.Send(command);
    ...
    public async Task Handle_WithMissingLabor_ShouldFail()
    {
        ...
        var command = new CreateWorkOrderCommand(Spots.C, vehicle.Id, scheduledAt, [repairTask.Id], Guid.NewGuid());
        var result = await _mediator.Send(command);
    ...
    public async Task Handle_WithVehicleConflict_ShouldFail()
    {
        ...
        var command1 = new CreateWorkOrderCommand(Spots.A, vehicle.Id, scheduledAt, [repairTask.Id], employee1.Id);
        var command2 = new CreateWorkOrderCommand(Spots.B, vehicle.Id, scheduledAt, [repairTask.Id], employee2.Id);
    ...
    public async Task Handle_WithLaborConflict_ShouldFail()
    {
        ...
        var command1 = new CreateWorkOrderCommand(Spots.A, vehicle1.Id, scheduledAt, [repairTask.Id], employee.Id);
        var command2 = new CreateWorkOrderCommand(Spots.B, vehicle2.Id, scheduledAt, [repairTask.Id], employee.Id);
    ...
    public async Task Handle_WithUnavailableSpot_ShouldFail()
    {
        ...
        var command1 = new CreateWorkOrderCommand(Spots.A, vehicle1.Id, scheduledAt, [repairTask.Id], employee1.Id);
        var command2 = new CreateWorkOrderCommand(Spots.A, vehicle2.Id, scheduledAt, [repairTask.Id], employee2.Id);
