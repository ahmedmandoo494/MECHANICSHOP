...
public class WorkOrderTestDataBuilder : ITestDataBuilder<WorkOrder>
{
    ...
    private Spots _spot = Spots.A;
    private List<RepairTask> _repairTasks = [];
    private WorkOrderStatus _state = WorkOrderStatus.Scheduled;
    ...
    public WorkOrderTestDataBuilder AtSpot(Spots spot)
    {
        _spot = spot;
        return this;
    }
    ...
    public WorkOrderTestDataBuilder WithState(WorkOrderStatus state)
    {
        _state = state;
        return this;
    }
    ...
    {
        _state = WorkOrderStatus.InProgress;
    ...
    {
        _state = WorkOrderStatus.Completed;
    ...
    public WorkOrder Build()
    {
        ...
        if (_state != WorkOrderStatus.Scheduled)
        {
            // Assuming you have a method to set state
            workOrder.UpdateStatus(_state);
        }
